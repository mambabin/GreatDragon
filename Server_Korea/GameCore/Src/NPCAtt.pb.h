...
class PB_NPCAtt : public ::google::protobuf::Message {
 public:
  ...
  static const int kGradeFieldNumber = 30;
...
// optional int32 Grade = 30;
inline bool PB_NPCAtt::has_Grade() const {
  return (_has_bits_[0] & 0x20000000u) != 0;
}
inline void PB_NPCAtt::set_has_Grade() {
  _has_bits_[0] |= 0x20000000u;
}
inline void PB_NPCAtt::clear_has_Grade() {
  _has_bits_[0] &= ~0x20000000u;
}
inline void PB_NPCAtt::clear_Grade() {
  Grade_ = 0;
  clear_has_Grade();
}
inline ::google::protobuf::int32 PB_NPCAtt::Grade() const {
  return Grade_;
}
inline void PB_NPCAtt::set_Grade(::google::protobuf::int32 value) {
  set_has_Grade();
  Grade_ = value;
}
