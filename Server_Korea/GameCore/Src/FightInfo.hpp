...
class FightAtt{
	...
	public:
		...
		inline int32_t pkLevel() const {
			return pkLevel_;
		}
		inline void set_pkLevel(int32_t value) {
			pkLevel_ = value;
		}
