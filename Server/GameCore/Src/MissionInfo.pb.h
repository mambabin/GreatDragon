...
const MissionOpen_Type MissionOpen_Type_Type_MAX = MissionOpen_Type_APPLY_MISSION;
...
const MissionTarget_Type MissionTarget_Type_Type_MAX = MissionTarget_Type_SURVIVE_TO;
...
const MissionAward_Type MissionAward_Type_Type_MAX = MissionAward_Type_ACTIVITY;
...
const MissionInfo_Type MissionInfo_Type_Type_MAX = MissionInfo_Type_LINE;
