...
enum AwardInfo_Type {
  ...
  AwardInfo_Type_YUEZHAN = 41,
  AwardInfo_Type_OPENSERVERSCORE = 42,
  AwardInfo_Type_DAILY_PK = 43,
  AwardInfo_Type_WEEKLY_PK = 44
};
bool AwardInfo_Type_IsValid(int value);
const AwardInfo_Type AwardInfo_Type_Type_MIN = AwardInfo_Type_ONLINE;
const AwardInfo_Type AwardInfo_Type_Type_MAX = AwardInfo_Type_WEEKLY_PK;
...
class AwardInfo : public ::google::protobuf::Message {
 public:
  ...
  static const Type YUEZHAN = AwardInfo_Type_YUEZHAN;
  static const Type OPENSERVERSCORE = AwardInfo_Type_OPENSERVERSCORE;
  static const Type DAILY_PK = AwardInfo_Type_DAILY_PK;
  static const Type WEEKLY_PK = AwardInfo_Type_WEEKLY_PK;
