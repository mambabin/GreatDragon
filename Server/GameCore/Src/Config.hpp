...
static inline const char * Config_AppKey(const char *platform) {
	if (strcmp(platform, "QQ") == 0)
		return "4578e54fb3a1bd18e0681bc1c734514e";
	else if (strcmp(platform, "WX") == 0)
		return "bc0994f30c0a12a9908e353cf05d4dea";
	else
		return "";
}
...
int Config_RidesPotentialExpend();
static inline int Config_RidesPotentitalExpend()
{
	return 10;
}
