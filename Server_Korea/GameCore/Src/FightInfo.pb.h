...
class PB_FightAtt : public ::google::protobuf::Message {
 public:
  ...
  static const int kPkLevelFieldNumber = 33;
...
// optional int32 pkLevel = 33;
inline bool PB_FightAtt::has_pkLevel() const {
  return (_has_bits_[0] & 0x04000000u) != 0;
}
inline void PB_FightAtt::set_has_pkLevel() {
  _has_bits_[0] |= 0x04000000u;
}
inline void PB_FightAtt::clear_has_pkLevel() {
  _has_bits_[0] &= ~0x04000000u;
}
inline void PB_FightAtt::clear_pkLevel() {
  pkLevel_ = 0;
  clear_has_pkLevel();
}
inline ::google::protobuf::int32 PB_FightAtt::pkLevel() const {
  return pkLevel_;
}
inline void PB_FightAtt::set_pkLevel(::google::protobuf::int32 value) {
  set_has_pkLevel();
  pkLevel_ = value;
}
