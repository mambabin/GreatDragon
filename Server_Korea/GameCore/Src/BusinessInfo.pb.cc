...
void protobuf_AssignDesc_BusinessInfo_2eproto() {
  ...
  static const int BusinessUnit_offsets_[10] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(BusinessUnit, resType_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(BusinessUnit, resValue_),
  };
...
const int BusinessUnit::kResTypeFieldNumber;
const int BusinessUnit::kResValueFieldNumber;
#endif  // !_MSC_VER
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 8: {
        ...
        if (input->ExpectTag(72)) goto parse_resType;
        break;
      }
      ...
      case 9: {
        ...
        if (input->ExpectTag(80)) goto parse_resValue;
        break;
      }
...
void BusinessUnit::SerializeWithCachedSizes(
  ...
  // optional int32 resType = 9;
  if (has_resType()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(9, this->resType(), output);
  }
  
  // optional int32 resValue = 10;
  if (has_resValue()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(10, this->resValue(), output);
  }
...
::google::protobuf::uint8* BusinessUnit::SerializeWithCachedSizesToArray(
  ...
  // optional int32 resType = 9;
  if (has_resType()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(9, this->resType(), target);
  }
  
  // optional int32 resValue = 10;
  if (has_resValue()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(10, this->resValue(), target);
  }
