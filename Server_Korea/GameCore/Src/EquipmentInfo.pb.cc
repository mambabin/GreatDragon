...
void protobuf_AssignDesc_EquipmentInfo_2eproto() {
  ...
  static const int EquipmentInfo_offsets_[27] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(EquipmentInfo, randomEffect_),
  };
  ...
  static const int PB_EquipAsset_offsets_[8] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(PB_EquipAsset, randomType_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(PB_EquipAsset, randomDelta_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(PB_EquipAsset, effectId_),
  };
  ...
  static const int BaseWing_offsets_[12] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(BaseWing, success_),
  };
...
void protobuf_AddDesc_EquipmentInfo_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "ItemBaseInfo.proto\032\rGodShip.proto\"\320\006\n\rEq"
    ...
    " \001(\005\022\024\n\014randomEffect\030\" \001(\005\"\225\001\n\004Type\022\010\n\004H"
    "EAD\020\000\022\t\n\005CHEST\020\001\022\014\n\010SHOULDER\020\002\022\t\n\005BOOTS\020"
    "\003\022\010\n\004HAND\020\004\022\n\n\006WEAPON\020\005\022\014\n\010NECKLACE\020\006\022\010\n"
    "\004RING\020\007\022\010\n\004BELT\020\010\022\014\n\010TROUSERS\020\t\022\013\n\007JEWEL"
    "RY\020\n\022\014\n\010BRACELET\020\013\"@\n\tColorType\022\t\n\005WHITE"
    "\020\000\022\t\n\005GREEN\020\001\022\010\n\004BLUE\020\002\022\n\n\006YELLOW\020\003\022\007\n\003R"
    "ED\020\004\"3\n\rAllEquipments\022\"\n\nequipments\030\001 \003("
    "\0132\016.EquipmentInfo\"\252\001\n\rPB_EquipAsset\022\020\n\004m"
    "ode\030\001 \001(\005:\002-1\022\023\n\013strongLevel\030\002 \001(\005\022\020\n\010ge"
    "mModel\030\003 \003(\005\022\017\n\007gemType\030\004 \003(\005\022\024\n\014enhance"
    "Delta\030\005 \003(\005\022\022\n\nrandomType\030\006 \003(\005\022\023\n\013rando"
    "mDelta\030\007 \003(\005\022\020\n\010effectId\030\010 \001(\005\"q\n\013EquipR"
    "ecipe\022\n\n\002id\030\001 \001(\005\022!\n\004type\030\002 \001(\0162\023.Equipm"
    "entInfo.Type\022\021\n\tmaterials\030\003 \003(\005\022\014\n\004nums\030"
    "\004 \003(\005\022\022\n\nequipments\030\005 \003(\005\"0\n\017AllEquipRec"
    "ipes\022\035\n\007recipes\030\001 \003(\0132\014.EquipRecipe\"\227\002\n\010"
    "BaseWing\022\r\n\005level\030\001 \001(\005\022\014\n\004name\030\002 \001(\t\022\r\n"
    "\005model\030\003 \003(\005\022\016\n\006effect\030\004 \003(\005\022\014\n\004desc\030\005 \001"
    "(\t\022\016\n\006degree\030\006 \001(\005\022\013\n\003att\030\007 \003(\005\022\r\n\005goods"
    "\030\010 \003(\005\022\r\n\005count\030\t \003(\005\022\013\n\003pic\030\n \001(\005\022&\n\tco"
    "lorType\030\013 \001(\0162\023.BaseWing.ColorType\022\017\n\007su"
    "ccess\030\014 \001(\002\"@\n\tColorType\022\t\n\005WHITE\020\000\022\t\n\005G"
    "REEN\020\001\022\010\n\004BLUE\020\002\022\n\n\006YELLOW\020\003\022\007\n\003RED\020\004\"(\n"
    "\014AllBaseWings\022\030\n\005wings\030\001 \003(\0132\t.BaseWing\""
    "\276\002\n\004Wing\022\n\n\002id\030\001 \001(\005\022\r\n\005model\030\002 \003(\005\022\016\n\006e"
    "ffect\030\003 \003(\005\022\013\n\003att\030\004 \003(\005\022\014\n\004desc\030\005 \001(\t\022\013"
    "\n\003pic\030\006 \001(\005\022\013\n\003rmb\030\007 \001(\005\022\"\n\tcolorType\030\010 "
    "\001(\0162\017.Wing.ColorType\022\014\n\004name\030\t \001(\t\022\020\n\010pv"
    "pScore\030\n \001(\005\022\021\n\tlovePoint\030\013 \001(\005\022\020\n\010godSc"
    "ore\030\014 \001(\005\022\031\n\021factionContribute\030\r \001(\005\022\020\n\010"
    "helpNode\030\016 \001(\005\"@\n\tColorType\022\t\n\005WHITE\020\000\022\t"
    "\n\005GREEN\020\001\022\010\n\004BLUE\020\002\022\n\n\006YELLOW\020\003\022\007\n\003RED\020\004"
    "\" \n\010AllWings\022\024\n\005wings\030\001 \003(\0132\005.Wing\"\203\001\n\017P"
    "B_EquipmentAtt\022\022\n\nequipments\030\001 \003(\003\022\020\n\004wi"
    "ng\030\003 \001(\005:\002-1\022\023\n\007fashion\030\004 \001(\005:\002-1\022\020\n\010bas"
    "eWing\030\005 \001(\010\022\021\n\005rides\030\006 \001(\005:\002-1\022\020\n\010godShi"
    "ps\030\007 \003(\005", 2128);
...
const int EquipmentInfo::kRandomEffectFieldNumber;
#endif  // !_MSC_VER
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 33: {
        ...
        if (input->ExpectTag(272)) goto parse_randomEffect;
        break;
      }
...
void EquipmentInfo::SerializeWithCachedSizes(
  ...
  // optional int32 randomEffect = 34;
  if (has_randomEffect()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(34, this->randomEffect(), output);
  }
...
::google::protobuf::uint8* EquipmentInfo::SerializeWithCachedSizesToArray(
  ...
  // optional int32 randomEffect = 34;
  if (has_randomEffect()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(34, this->randomEffect(), target);
  }
...
void EquipmentInfo::MergeFrom(const EquipmentInfo& from) {
  ...
  if (from._has_bits_[25 / 32] & (0xffu << (25 % 32))) {
    ...
    if (from.has_randomEffect()) {
      set_randomEffect(from.randomEffect());
    }
  }
...
void EquipmentInfo::Swap(EquipmentInfo* other) {
  if (other != this) {
    ...
    std::swap(randomEffect_, other->randomEffect_);
...
const int PB_EquipAsset::kRandomTypeFieldNumber;
const int PB_EquipAsset::kRandomDeltaFieldNumber;
const int PB_EquipAsset::kEffectIdFieldNumber;
#endif  // !_MSC_VER
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 5: {
        ...
        if (input->ExpectTag(40)) goto parse_enhanceDelta;
        if (input->ExpectTag(48)) goto parse_randomType;
        break;
      }
      ...
      case 6: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_randomType:
          DO_((::google::protobuf::internal::WireFormatLite::ReadRepeatedPrimitive<
                   ::google::protobuf::int32, ::google::protobuf::internal::WireFormatLite::TYPE_INT32>(
                 1, 48, input, this->mutable_randomType())));
        } else if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag)
                   == ::google::protobuf::internal::WireFormatLite::
                      WIRETYPE_LENGTH_DELIMITED) {
          DO_((::google::protobuf::internal::WireFormatLite::ReadPackedPrimitiveNoInline<
                   ::google::protobuf::int32, ::google::protobuf::internal::WireFormatLite::TYPE_INT32>(
                 input, this->mutable_randomType())));
        } else {
          goto handle_uninterpreted;
        }
        if (input->ExpectTag(48)) goto parse_randomType;
        if (input->ExpectTag(56)) goto parse_randomDelta;
        break;
      }
      ...
      case 7: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_randomDelta:
          DO_((::google::protobuf::internal::WireFormatLite::ReadRepeatedPrimitive<
                   ::google::protobuf::int32, ::google::protobuf::internal::WireFormatLite::TYPE_INT32>(
                 1, 56, input, this->mutable_randomDelta())));
        } else if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag)
                   == ::google::protobuf::internal::WireFormatLite::
                      WIRETYPE_LENGTH_DELIMITED) {
          DO_((::google::protobuf::internal::WireFormatLite::ReadPackedPrimitiveNoInline<
                   ::google::protobuf::int32, ::google::protobuf::internal::WireFormatLite::TYPE_INT32>(
                 input, this->mutable_randomDelta())));
        } else {
          goto handle_uninterpreted;
        }
        if (input->ExpectTag(56)) goto parse_randomDelta;
        if (input->ExpectTag(64)) goto parse_effectId;
        break;
      }
...
void PB_EquipAsset::SerializeWithCachedSizes(
  ...
  // repeated int32 randomType = 6;
  for (int i = 0; i < this->randomType_size(); i++) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(
      6, this->randomType(i), output);
  }
  
  // repeated int32 randomDelta = 7;
  for (int i = 0; i < this->randomDelta_size(); i++) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(
      7, this->randomDelta(i), output);
  }
  
  // optional int32 effectId = 8;
  if (has_effectId()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(8, this->effectId(), output);
  }
...
::google::protobuf::uint8* PB_EquipAsset::SerializeWithCachedSizesToArray(
  ...
  for (int i = 0; i < this->randomType_size(); i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      WriteInt32ToArray(6, this->randomType(i), target);
  }
  
  // repeated int32 randomDelta = 7;
  for (int i = 0; i < this->randomDelta_size(); i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      WriteInt32ToArray(7, this->randomDelta(i), target);
  }
  
  // optional int32 effectId = 8;
  if (has_effectId()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(8, this->effectId(), target);
  }
...
int PB_EquipAsset::ByteSize() const {
  ...
  // repeated int32 randomType = 6;
  {
    ...
    for (int i = 0; i < this->randomType_size(); i++) {
      data_size += ::google::protobuf::internal::WireFormatLite::
        Int32Size(this->randomType(i));
    }
    total_size += 1 * this->randomType_size() + data_size;
  }
  ...
  // repeated int32 randomDelta = 7;
  {
    ...
    for (int i = 0; i < this->randomDelta_size(); i++) {
      data_size += ::google::protobuf::internal::WireFormatLite::
        Int32Size(this->randomDelta(i));
    }
    total_size += 1 * this->randomDelta_size() + data_size;
  }
...
void PB_EquipAsset::MergeFrom(const PB_EquipAsset& from) {
  ...
  randomType_.MergeFrom(from.randomType_);
  randomDelta_.MergeFrom(from.randomDelta_);
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from.has_mode()) {
      set_mode(from.mode());
    }
...
void PB_EquipAsset::Swap(PB_EquipAsset* other) {
  if (other != this) {
    ...
    randomType_.Swap(&other->randomType_);
    randomDelta_.Swap(&other->randomDelta_);
...
const int BaseWing::kSuccessFieldNumber;
#endif  // !_MSC_VER
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 11: {
        ...
        if (input->ExpectTag(101)) goto parse_success;
        break;
      }
...
void BaseWing::SerializeWithCachedSizes(
  ...
  // optional float success = 12;
  if (has_success()) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(12, this->success(), output);
  }
...
::google::protobuf::uint8* BaseWing::SerializeWithCachedSizesToArray(
  ...
  for (int i = 0; i < this->goods_size(); i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      WriteInt32ToArray(8, this->goods(i), target);
  }
  ...
  // optional float success = 12;
  if (has_success()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFloatToArray(12, this->success(), target);
  }
...
int BaseWing::ByteSize() const {
  ...
  // repeated int32 goods = 8;
  {
    ...
    for (int i = 0; i < this->goods_size(); i++) {
      data_size += ::google::protobuf::internal::WireFormatLite::
        Int32Size(this->goods(i));
    }
    total_size += 1 * this->goods_size() + data_size;
  }
