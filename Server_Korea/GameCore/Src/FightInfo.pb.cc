...
void protobuf_AssignDesc_FightInfo_2eproto() {
  ...
  static const int PB_FightAtt_offsets_[27] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(PB_FightAtt, pkLevel_),
  };
...
void protobuf_AddDesc_FightInfo_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "\007toDodge\030\003 \001(\005\022\022\n\ntoAccuracy\030\004 \001(\005\"\340\005\n\013P"
...
const int PB_FightAtt::kPkLevelFieldNumber;
#endif  // !_MSC_VER
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 32: {
        ...
        if (input->ExpectTag(264)) goto parse_pkLevel;
        break;
      }
...
void PB_FightAtt::SerializeWithCachedSizes(
  ...
  // optional int32 pkLevel = 33;
  if (has_pkLevel()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(33, this->pkLevel(), output);
  }
...
::google::protobuf::uint8* PB_FightAtt::SerializeWithCachedSizesToArray(
  ...
  // optional int32 pkLevel = 33;
  if (has_pkLevel()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(33, this->pkLevel(), target);
  }
